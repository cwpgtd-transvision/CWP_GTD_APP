<%@ Page Title="" Language="C#" MasterPageFile="~/GTDMaster.master" AutoEventWireup="true" CodeFile="RptDcuDetails.aspx.cs" Inherits="RptDcuDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        ...
        function LoginwiseFreeze() {
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/LoginwiseFreeze",
                data: '{}',
        ...
        function Bindgenerators() {
            ...
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/Bindgenerators",
                data: JSON.stringify({
        ...
        function BindConsumer() {
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindConsumer",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function BindZone_1(COMPID) {
            return $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindZone_1",
        ...
        function BindZone() {
            return $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindZone",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json"
        ...
        function BindCircle() {
            ...
            return $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindCircle",
        ...
        function BindDivision() {
            ...
            return $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindDivision",
        ...
        function BindSubStationName() {
            ...
            return $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindSubStationName",
        ...
        function BindVoltage() {
            ...
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindVoltage",
        ...
        function BindGeneration() {
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindGeneration",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function BindEHT() {
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindEHT",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function BindGenName() {
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindGenName",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function BindGENERATION_TYPE() {
            ...
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindGENERATION_TYPE",
        ...
        function BindSubStation() {
            ...
            $.ajax({
                type: "POST",
                url: "/EntityManagment/RptDcuDetails.aspx/BindSubStation",
        ...
        function GetData2() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: "application/json;charset=utf-8",
                url: "/EntityManagment/RptDcuDetails.aspx/GetDataReport",
                data: JSON.stringify({
        ...
        function BindHandsOnTable(data) {
            ...
            head = ['SLNO', 'ZONE', 'CIRCLE', 'DIVISION', 'STATION', 'ENTITY/IFPOINT NAME ', 'ENTITY TYPE', 'MTRSRLNO', 'NAME', 'DCU IP', 'DCUFILEPATH', 'DCUADDEDON', 'DCUADDEDBY']



            if (zid != '0') {

                head = ['SLNO', 'CIRCLE', 'DIVISION', 'STATION', 'ENTITY/IFPOINT NAME ', 'ENTITY TYPE', 'MTRSRLNO', 'NAME', 'DCU IP', 'DCUFILEPATH', 'DCUADDEDON', 'DCUADDEDBY']

            }
            if (cirid != '0' && cirid != null) {

                head = ['SLNO', 'DIVISION', 'STATION', 'ENTITY/IFPOINT NAME ', 'ENTITY TYPE', 'MTRSRLNO', 'NAME', 'DCU IP', 'DCUFILEPATH', 'DCUADDEDON', 'DCUADDEDBY']

            }
            if (divid != '0' && divid != null) {

                head = ['SLNO', 'STATION', 'ENTITY/IFPOINT NAME ', 'ENTITY TYPE', 'MTRSRLNO', 'NAME', 'DCU IP', 'DCUFILEPATH', 'DCUADDEDON', 'DCUADDEDBY']

            }
            if (staid != '0' && staid != null) {

                head = ['SLNO', 'ENTITY/IFPOINT NAME ', 'ENTITY TYPE', 'MTRSRLNO', 'NAME', 'DCU IP', 'DCUFILEPATH', 'DCUADDEDON', 'DCUADDEDBY']
        ...
        function GetData1() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: "application/json;charset=utf-8",
                url: "/EntityManagment/RptDcuDetails.aspx/GetDataReportkpcl",
        ...
        function BindHandsOnTable1(data) {
            ...
            const hot = new Handsontable(container, {
                data: data,
                colHeaders: head = ['SLNO', 'GENERATION', 'GENERATION TYPE', 'GENERATION STATION', 'UNITS',
                    'UNITTYPE', 'CONSUMER TYPE', 'MTRSRLNO', 'DCU TYPE', 'DCU IP', '	DCUFILEPATH', '	DCUADDEDON', 'DCUADDEDBY'],
                contextMenu: false,
                height: 450,
                fixedColumnsLeft: 0,
                readOnly: true,
            ...
            //$('#exportExcel1').click(function () {
                ...
                const fileName = `DCU_DETAILS_KPCL_${formattedDate}.xlsx`;
    ...
    <div class="container-fluid mt-2">
        <div class="card">
            <div class="card-header ">
                <div class="card-title">DCU DETAILS </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Footer.aspx.cs" Inherits="templates_Footer" %>

<!-- Footer -->
<div class="navbar navbar-sm navbar-footer border-top">
	<div class="container-fluid">
		<span>&copy; 2025 <a href="https://transvisionsolutions.com/">Transvision Software and Data Solutions Private Limited</a></span>
		...
		<li class="nav-item ms-md-1">
				<a href="#" class="navbar-nav-link navbar-nav-link-icon text-primary bg-primary bg-opacity-10 fw-semibold rounded" target="_blank">
					<div class="d-flex align-items-center mx-md-1">
						...
						<span class="d-none d-md-inline-block ms-2">User Manual</span>
					</div>
				</a>
			</li>
		<%--	<li class="nav-item ms-md-1">

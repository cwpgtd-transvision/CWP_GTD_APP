<%@ Page Language="C#" AutoEventWireup="true" CodeFile="material.aspx.cs" Inherits="templates_Footer" %>
<!-- Material icon set -->
<div class="card">
	<div class="card-header">
		<h5 class="mb-0">Material icon set</h5>
	</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="font-awesome.aspx.cs" Inherits="templates_Footer" %>
<!-- Icons preview -->
<div class="card">
	<div class="card-header">
		<h5 class="mb-0">Font Awesome icon set</h5>
	</div>
	...
	<div class="card-body">
		...
		<div class="row g-0 glyphs">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-backspace me-3 fa-2x"></i>
					<div>backspace <div class="opacity-50">f55a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-backward me-3 fa-2x"></i>
					<div>backward <div class="opacity-50">f04a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-balance-scale me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-battery-three-quarters me-3 fa-2x"></i>
					<div>battery-three-quarters <div class="opacity-50">f241</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bed me-3 fa-2x"></i>
					<div>bed <div class="opacity-50">f236</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-beer me-3 fa-2x"></i>
					<div>beer <div class="opacity-50">f0fc</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-behance me-3 fa-2x"></i>
					<div>behance <div class="opacity-50">f1b4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-behance-square me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-book-dead me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-book-reader me-3 fa-2x"></i>
					<div>book-reader <div class="opacity-50">f5da</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bookmark me-3 fa-2x"></i>
					<div>bookmark <div class="opacity-50">f02e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-bookmark me-3 fa-2x"></i>
					<div>bookmark <div class="opacity-50">f02e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bowling-ball me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-building me-3 fa-2x"></i>
					<div>building <div class="opacity-50">f1ad</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bullhorn me-3 fa-2x"></i>
					<div>bullhorn <div class="opacity-50">f0a1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bullseye me-3 fa-2x"></i>
					<div>bullseye <div class="opacity-50">f140</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-burn me-3 fa-2x"></i>
					<div>burn <div class="opacity-50">f46a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-buromobelexperte me-3 fa-2x"></i>
					<div>buromobelexperte <div class="opacity-50">f37f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bus me-3 fa-2x"></i>
					<div>bus <div class="opacity-50">f207</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-bus-alt me-3 fa-2x"></i>
					<div>bus-alt <div class="opacity-50">f55e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-business-time me-3 fa-2x"></i>
					<div>business-time <div class="opacity-50">f64a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-buysellads me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-calendar me-3 fa-2x"></i>
					<div>calendar <div class="opacity-50">f133</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar me-3 fa-2x"></i>
					<div>calendar <div class="opacity-50">f133</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar-alt me-3 fa-2x"></i>
					<div>calendar-alt <div class="opacity-50">f073</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar-check me-3 fa-2x"></i>
					<div>calendar-check <div class="opacity-50">f274</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-calendar-minus me-3 fa-2x"></i>
					<div>calendar-minus <div class="opacity-50">f272</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar-minus me-3 fa-2x"></i>
					<div>calendar-minus <div class="opacity-50">f272</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-calendar-plus me-3 fa-2x"></i>
					<div>calendar-plus <div class="opacity-50">f271</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar-plus me-3 fa-2x"></i>
					<div>calendar-plus <div class="opacity-50">f271</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-calendar-times me-3 fa-2x"></i>
					<div>calendar-times <div class="opacity-50">f273</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-camera-retro me-3 fa-2x"></i>
					<div>camera-retro <div class="opacity-50">f083</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-campground me-3 fa-2x"></i>
					<div>campground <div class="opacity-50">f6bb</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cannabis me-3 fa-2x"></i>
					<div>cannabis <div class="opacity-50">f55f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-capsules me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-centercode me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-chart-bar me-3 fa-2x"></i>
					<div>chart-bar <div class="opacity-50">f080</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-check me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-clock me-3 fa-2x"></i>
					<div>clock <div class="opacity-50">f017</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-clone me-3 fa-2x"></i>
					<div>clone <div class="opacity-50">f24d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-clone me-3 fa-2x"></i>
					<div>clone <div class="opacity-50">f24d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-closed-captioning me-3 fa-2x"></i>
					<div>closed-captioning <div class="opacity-50">f20a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-closed-captioning me-3 fa-2x"></i>
					<div>closed-captioning <div class="opacity-50">f20a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud me-3 fa-2x"></i>
					<div>cloud <div class="opacity-50">f0c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-download-alt me-3 fa-2x"></i>
					<div>cloud-download-alt <div class="opacity-50">f381</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-meatball me-3 fa-2x"></i>
					<div>cloud-meatball <div class="opacity-50">f73b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-moon me-3 fa-2x"></i>
					<div>cloud-moon <div class="opacity-50">f6c3</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-moon-rain me-3 fa-2x"></i>
					<div>cloud-moon-rain <div class="opacity-50">f73c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-rain me-3 fa-2x"></i>
					<div>cloud-rain <div class="opacity-50">f73d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-cloud-showers-heavy me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-dot-circle me-3 fa-2x"></i>
					<div>dot-circle <div class="opacity-50">f192</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-dot-circle me-3 fa-2x"></i>
					<div>dot-circle <div class="opacity-50">f192</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-dove me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-edit me-3 fa-2x"></i>
					<div>edit <div class="opacity-50">f044</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-eject me-3 fa-2x"></i>
					<div>eject <div class="opacity-50">f052</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-elementor me-3 fa-2x"></i>
					<div>elementor <div class="opacity-50">f430</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-ellipsis-h me-3 fa-2x"></i>
					<div>ellipsis-h <div class="opacity-50">f141</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-ellipsis-v me-3 fa-2x"></i>
					<div>ellipsis-v <div class="opacity-50">f142</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-ello me-3 fa-2x"></i>
					<div>ello <div class="opacity-50">f5f1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-ember me-3 fa-2x"></i>
					<div>ember <div class="opacity-50">f423</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-empire me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-envelope me-3 fa-2x"></i>
					<div>envelope <div class="opacity-50">f0e0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-envelope-open me-3 fa-2x"></i>
					<div>envelope-open <div class="opacity-50">f2b6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-envelope-open me-3 fa-2x"></i>
					<div>envelope-open <div class="opacity-50">f2b6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-envelope-open-text me-3 fa-2x"></i>
					<div>envelope-open-text <div class="opacity-50">f658</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-envelope-square me-3 fa-2x"></i>
					<div>envelope-square <div class="opacity-50">f199</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-envira me-3 fa-2x"></i>
					<div>envira <div class="opacity-50">f299</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-equals me-3 fa-2x"></i>
					<div>equals <div class="opacity-50">f52c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-eraser me-3 fa-2x"></i>
					<div>eraser <div class="opacity-50">f12d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-erlang me-3 fa-2x"></i>
					<div>erlang <div class="opacity-50">f39d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-ethereum me-3 fa-2x"></i>
					<div>ethereum <div class="opacity-50">f42e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-etsy me-3 fa-2x"></i>
					<div>etsy <div class="opacity-50">f2d7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-euro-sign me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-exclamation me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-expand me-3 fa-2x"></i>
					<div>expand <div class="opacity-50">f065</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-expand-arrows-alt me-3 fa-2x"></i>
					<div>expand-arrows-alt <div class="opacity-50">f31e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-expeditedssl me-3 fa-2x"></i>
					<div>expeditedssl <div class="opacity-50">f23e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-external-link-alt me-3 fa-2x"></i>
					<div>external-link-alt <div class="opacity-50">f35d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-external-link-square-alt me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-eye me-3 fa-2x"></i>
					<div>eye <div class="opacity-50">f06e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-eye-dropper me-3 fa-2x"></i>
					<div>eye-dropper <div class="opacity-50">f1fb</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-eye-slash me-3 fa-2x"></i>
					<div>eye-slash <div class="opacity-50">f070</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-eye-slash me-3 fa-2x"></i>
					<div>eye-slash <div class="opacity-50">f070</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-female me-3 fa-2x"></i>
					<div>female <div class="opacity-50">f182</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-fighter-jet me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file me-3 fa-2x"></i>
					<div>file <div class="opacity-50">f15b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-alt me-3 fa-2x"></i>
					<div>file-alt <div class="opacity-50">f15c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-archive me-3 fa-2x"></i>
					<div>file-archive <div class="opacity-50">f1c6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-archive me-3 fa-2x"></i>
					<div>file-archive <div class="opacity-50">f1c6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-audio me-3 fa-2x"></i>
					<div>file-audio <div class="opacity-50">f1c7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-code me-3 fa-2x"></i>
					<div>file-code <div class="opacity-50">f1c9</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-code me-3 fa-2x"></i>
					<div>file-code <div class="opacity-50">f1c9</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-contract me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-download me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-excel me-3 fa-2x"></i>
					<div>file-excel <div class="opacity-50">f1c3</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-export me-3 fa-2x"></i>
					<div>file-export <div class="opacity-50">f56e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-image me-3 fa-2x"></i>
					<div>file-image <div class="opacity-50">f1c5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-image me-3 fa-2x"></i>
					<div>file-image <div class="opacity-50">f1c5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-import me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-invoice-dollar me-3 fa-2x"></i>
					<div>file-invoice-dollar <div class="opacity-50">f571</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-medical me-3 fa-2x"></i>
					<div>file-medical <div class="opacity-50">f477</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-medical-alt me-3 fa-2x"></i>
					<div>file-medical-alt <div class="opacity-50">f478</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-pdf me-3 fa-2x"></i>
					<div>file-pdf <div class="opacity-50">f1c1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-pdf me-3 fa-2x"></i>
					<div>file-pdf <div class="opacity-50">f1c1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-powerpoint me-3 fa-2x"></i>
					<div>file-powerpoint <div class="opacity-50">f1c4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-powerpoint me-3 fa-2x"></i>
					<div>file-powerpoint <div class="opacity-50">f1c4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-prescription me-3 fa-2x"></i>
					<div>file-prescription <div class="opacity-50">f572</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-signature me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-video me-3 fa-2x"></i>
					<div>file-video <div class="opacity-50">f1c8</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-file-word me-3 fa-2x"></i>
					<div>file-word <div class="opacity-50">f1c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-file-word me-3 fa-2x"></i>
					<div>file-word <div class="opacity-50">f1c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-fill me-3 fa-2x"></i>
					<div>fill <div class="opacity-50">f575</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-fill-drip me-3 fa-2x"></i>
					<div>fill-drip <div class="opacity-50">f576</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-film me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-flickr me-3 fa-2x"></i>
					<div>flickr <div class="opacity-50">f16e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-flipboard me-3 fa-2x"></i>
					<div>flipboard <div class="opacity-50">f44d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-flushed me-3 fa-2x"></i>
					<div>flushed <div class="opacity-50">f579</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-flushed me-3 fa-2x"></i>
					<div>flushed <div class="opacity-50">f579</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-fly me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-globe-africa me-3 fa-2x"></i>
					<div>globe-africa <div class="opacity-50">f57c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-globe-americas me-3 fa-2x"></i>
					<div>globe-americas <div class="opacity-50">f57d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-globe-asia me-3 fa-2x"></i>
					<div>globe-asia <div class="opacity-50">f57e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-gofore me-3 fa-2x"></i>
					<div>gofore <div class="opacity-50">f3a7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-golf-ball me-3 fa-2x"></i>
					<div>golf-ball <div class="opacity-50">f450</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-goodreads me-3 fa-2x"></i>
					<div>goodreads <div class="opacity-50">f3a8</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-goodreads-g me-3 fa-2x"></i>
					<div>goodreads-g <div class="opacity-50">f3a9</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google me-3 fa-2x"></i>
					<div>google <div class="opacity-50">f1a0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-drive me-3 fa-2x"></i>
					<div>google-drive <div class="opacity-50">f3aa</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-play me-3 fa-2x"></i>
					<div>google-play <div class="opacity-50">f3ab</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-plus me-3 fa-2x"></i>
					<div>google-plus <div class="opacity-50">f2b3</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-plus-g me-3 fa-2x"></i>
					<div>google-plus-g <div class="opacity-50">f0d5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-plus-square me-3 fa-2x"></i>
					<div>google-plus-square <div class="opacity-50">f0d4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-google-wallet me-3 fa-2x"></i>
					<div>google-wallet <div class="opacity-50">f1ee</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-gopuram me-3 fa-2x"></i>
					<div>gopuram <div class="opacity-50">f664</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-graduation-cap me-3 fa-2x"></i>
					<div>graduation-cap <div class="opacity-50">f19d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-gratipay me-3 fa-2x"></i>
					<div>gratipay <div class="opacity-50">f184</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-grav me-3 fa-2x"></i>
					<div>grav <div class="opacity-50">f2d6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-greater-than me-3 fa-2x"></i>
					<div>greater-than <div class="opacity-50">f531</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-greater-than-equal me-3 fa-2x"></i>
					<div>greater-than-equal <div class="opacity-50">f532</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grimace me-3 fa-2x"></i>
					<div>grimace <div class="opacity-50">f57f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grimace me-3 fa-2x"></i>
					<div>grimace <div class="opacity-50">f57f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin me-3 fa-2x"></i>
					<div>grin <div class="opacity-50">f580</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin me-3 fa-2x"></i>
					<div>grin <div class="opacity-50">f580</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-alt me-3 fa-2x"></i>
					<div>grin-alt <div class="opacity-50">f581</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-alt me-3 fa-2x"></i>
					<div>grin-alt <div class="opacity-50">f581</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-beam me-3 fa-2x"></i>
					<div>grin-beam <div class="opacity-50">f582</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-beam me-3 fa-2x"></i>
					<div>grin-beam <div class="opacity-50">f582</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-beam-sweat me-3 fa-2x"></i>
					<div>grin-beam-sweat <div class="opacity-50">f583</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-beam-sweat me-3 fa-2x"></i>
					<div>grin-beam-sweat <div class="opacity-50">f583</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-hearts me-3 fa-2x"></i>
					<div>grin-hearts <div class="opacity-50">f584</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-hearts me-3 fa-2x"></i>
					<div>grin-hearts <div class="opacity-50">f584</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-squint me-3 fa-2x"></i>
					<div>grin-squint <div class="opacity-50">f585</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-squint me-3 fa-2x"></i>
					<div>grin-squint <div class="opacity-50">f585</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-squint-tears me-3 fa-2x"></i>
					<div>grin-squint-tears <div class="opacity-50">f586</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-squint-tears me-3 fa-2x"></i>
					<div>grin-squint-tears <div class="opacity-50">f586</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-stars me-3 fa-2x"></i>
					<div>grin-stars <div class="opacity-50">f587</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-stars me-3 fa-2x"></i>
					<div>grin-stars <div class="opacity-50">f587</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-tears me-3 fa-2x"></i>
					<div>grin-tears <div class="opacity-50">f588</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-tears me-3 fa-2x"></i>
					<div>grin-tears <div class="opacity-50">f588</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-tongue me-3 fa-2x"></i>
					<div>grin-tongue <div class="opacity-50">f589</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-tongue me-3 fa-2x"></i>
					<div>grin-tongue <div class="opacity-50">f589</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-tongue-squint me-3 fa-2x"></i>
					<div>grin-tongue-squint <div class="opacity-50">f58a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-tongue-squint me-3 fa-2x"></i>
					<div>grin-tongue-squint <div class="opacity-50">f58a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-tongue-wink me-3 fa-2x"></i>
					<div>grin-tongue-wink <div class="opacity-50">f58b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-tongue-wink me-3 fa-2x"></i>
					<div>grin-tongue-wink <div class="opacity-50">f58b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grin-wink me-3 fa-2x"></i>
					<div>grin-wink <div class="opacity-50">f58c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-grin-wink me-3 fa-2x"></i>
					<div>grin-wink <div class="opacity-50">f58c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grip-horizontal me-3 fa-2x"></i>
					<div>grip-horizontal <div class="opacity-50">f58d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-grip-vertical me-3 fa-2x"></i>
					<div>grip-vertical <div class="opacity-50">f58e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-gripfire me-3 fa-2x"></i>
					<div>gripfire <div class="opacity-50">f3ac</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-grunt me-3 fa-2x"></i>
					<div>grunt <div class="opacity-50">f3ad</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-gulp me-3 fa-2x"></i>
					<div>gulp <div class="opacity-50">f3ae</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-h-square me-3 fa-2x"></i>
					<div>h-square <div class="opacity-50">f0fd</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-hacker-news me-3 fa-2x"></i>
					<div>hacker-news <div class="opacity-50">f1d4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-hacker-news-square me-3 fa-2x"></i>
					<div>hacker-news-square <div class="opacity-50">f3af</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-hackerrank me-3 fa-2x"></i>
					<div>hackerrank <div class="opacity-50">f5f7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hammer me-3 fa-2x"></i>
					<div>hammer <div class="opacity-50">f6e3</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hamsa me-3 fa-2x"></i>
					<div>hamsa <div class="opacity-50">f665</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-holding me-3 fa-2x"></i>
					<div>hand-holding <div class="opacity-50">f4bd</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-holding-heart me-3 fa-2x"></i>
					<div>hand-holding-heart <div class="opacity-50">f4be</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-holding-usd me-3 fa-2x"></i>
					<div>hand-holding-usd <div class="opacity-50">f4c0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-lizard me-3 fa-2x"></i>
					<div>hand-lizard <div class="opacity-50">f258</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-lizard me-3 fa-2x"></i>
					<div>hand-lizard <div class="opacity-50">f258</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-paper me-3 fa-2x"></i>
					<div>hand-paper <div class="opacity-50">f256</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-paper me-3 fa-2x"></i>
					<div>hand-paper <div class="opacity-50">f256</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-peace me-3 fa-2x"></i>
					<div>hand-peace <div class="opacity-50">f25b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-peace me-3 fa-2x"></i>
					<div>hand-peace <div class="opacity-50">f25b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-point-down me-3 fa-2x"></i>
					<div>hand-point-down <div class="opacity-50">f0a7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-point-down me-3 fa-2x"></i>
					<div>hand-point-down <div class="opacity-50">f0a7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-point-left me-3 fa-2x"></i>
					<div>hand-point-left <div class="opacity-50">f0a5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-point-left me-3 fa-2x"></i>
					<div>hand-point-left <div class="opacity-50">f0a5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-point-right me-3 fa-2x"></i>
					<div>hand-point-right <div class="opacity-50">f0a4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-point-right me-3 fa-2x"></i>
					<div>hand-point-right <div class="opacity-50">f0a4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-point-up me-3 fa-2x"></i>
					<div>hand-point-up <div class="opacity-50">f0a6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-point-up me-3 fa-2x"></i>
					<div>hand-point-up <div class="opacity-50">f0a6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-pointer me-3 fa-2x"></i>
					<div>hand-pointer <div class="opacity-50">f25a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-pointer me-3 fa-2x"></i>
					<div>hand-pointer <div class="opacity-50">f25a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-rock me-3 fa-2x"></i>
					<div>hand-rock <div class="opacity-50">f255</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-rock me-3 fa-2x"></i>
					<div>hand-rock <div class="opacity-50">f255</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-scissors me-3 fa-2x"></i>
					<div>hand-scissors <div class="opacity-50">f257</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-scissors me-3 fa-2x"></i>
					<div>hand-scissors <div class="opacity-50">f257</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hand-spock me-3 fa-2x"></i>
					<div>hand-spock <div class="opacity-50">f259</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hand-spock me-3 fa-2x"></i>
					<div>hand-spock <div class="opacity-50">f259</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hands me-3 fa-2x"></i>
					<div>hands <div class="opacity-50">f4c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hands-helping me-3 fa-2x"></i>
					<div>hands-helping <div class="opacity-50">f4c4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-handshake me-3 fa-2x"></i>
					<div>handshake <div class="opacity-50">f2b5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-handshake me-3 fa-2x"></i>
					<div>handshake <div class="opacity-50">f2b5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hanukiah me-3 fa-2x"></i>
					<div>hanukiah <div class="opacity-50">f6e6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hashtag me-3 fa-2x"></i>
					<div>hashtag <div class="opacity-50">f292</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hat-wizard me-3 fa-2x"></i>
					<div>hat-wizard <div class="opacity-50">f6e8</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-haykal me-3 fa-2x"></i>
					<div>haykal <div class="opacity-50">f666</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hdd me-3 fa-2x"></i>
					<div>hdd <div class="opacity-50">f0a0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-hdd me-3 fa-2x"></i>
					<div>hdd <div class="opacity-50">f0a0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-heading me-3 fa-2x"></i>
					<div>heading <div class="opacity-50">f1dc</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-headphones me-3 fa-2x"></i>
					<div>headphones <div class="opacity-50">f025</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-headphones-alt me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-heart me-3 fa-2x"></i>
					<div>heart <div class="opacity-50">f004</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-heartbeat me-3 fa-2x"></i>
					<div>heartbeat <div class="opacity-50">f21e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-helicopter me-3 fa-2x"></i>
					<div>helicopter <div class="opacity-50">f533</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-highlighter me-3 fa-2x"></i>
					<div>highlighter <div class="opacity-50">f591</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hiking me-3 fa-2x"></i>
					<div>hiking <div class="opacity-50">f6ec</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-hippo me-3 fa-2x"></i>
					<div>hippo <div class="opacity-50">f6ed</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-hips me-3 fa-2x"></i>
					<div>hips <div class="opacity-50">f452</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-hire-a-helper me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-id-badge me-3 fa-2x"></i>
					<div>id-badge <div class="opacity-50">f2c1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-id-card me-3 fa-2x"></i>
					<div>id-card <div class="opacity-50">f2c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-id-card me-3 fa-2x"></i>
					<div>id-card <div class="opacity-50">f2c2</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-id-card-alt me-3 fa-2x"></i>
					<div>id-card-alt <div class="opacity-50">f47f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-image me-3 fa-2x"></i>
					<div>image <div class="opacity-50">f03e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-image me-3 fa-2x"></i>
					<div>image <div class="opacity-50">f03e</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-images me-3 fa-2x"></i>
					<div>images <div class="opacity-50">f302</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-imdb me-3 fa-2x"></i>
					<div>imdb <div class="opacity-50">f2d8</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-inbox me-3 fa-2x"></i>
					<div>inbox <div class="opacity-50">f01c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-indent me-3 fa-2x"></i>
					<div>indent <div class="opacity-50">f03c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-industry me-3 fa-2x"></i>
					<div>industry <div class="opacity-50">f275</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-infinity me-3 fa-2x"></i>
					<div>infinity <div class="opacity-50">f534</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-info me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-keybase me-3 fa-2x"></i>
					<div>keybase <div class="opacity-50">f4f5</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-keyboard me-3 fa-2x"></i>
					<div>keyboard <div class="opacity-50">f11c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-keyboard me-3 fa-2x"></i>
					<div>keyboard <div class="opacity-50">f11c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-keycdn me-3 fa-2x"></i>
					<div>keycdn <div class="opacity-50">f3ba</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-khanda me-3 fa-2x"></i>
					<div>khanda <div class="opacity-50">f66d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-kickstarter me-3 fa-2x"></i>
					<div>kickstarter <div class="opacity-50">f3bb</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-kickstarter-k me-3 fa-2x"></i>
					<div>kickstarter-k <div class="opacity-50">f3bc</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-kiss me-3 fa-2x"></i>
					<div>kiss <div class="opacity-50">f596</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-kiss me-3 fa-2x"></i>
					<div>kiss <div class="opacity-50">f596</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-kiss-beam me-3 fa-2x"></i>
					<div>kiss-beam <div class="opacity-50">f597</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-kiss-beam me-3 fa-2x"></i>
					<div>kiss-beam <div class="opacity-50">f597</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-kiss-wink-heart me-3 fa-2x"></i>
					<div>kiss-wink-heart <div class="opacity-50">f598</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-kiss-wink-heart me-3 fa-2x"></i>
					<div>kiss-wink-heart <div class="opacity-50">f598</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-kiwi-bird me-3 fa-2x"></i>
					<div>kiwi-bird <div class="opacity-50">f535</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-korvue me-3 fa-2x"></i>
					<div>korvue <div class="opacity-50">f42f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-landmark me-3 fa-2x"></i>
					<div>landmark <div class="opacity-50">f66f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-language me-3 fa-2x"></i>
					<div>language <div class="opacity-50">f1ab</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laptop me-3 fa-2x"></i>
					<div>laptop <div class="opacity-50">f109</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laptop-code me-3 fa-2x"></i>
					<div>laptop-code <div class="opacity-50">f5fc</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-laravel me-3 fa-2x"></i>
					<div>laravel <div class="opacity-50">f3bd</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-lastfm me-3 fa-2x"></i>
					<div>lastfm <div class="opacity-50">f202</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-lastfm-square me-3 fa-2x"></i>
					<div>lastfm-square <div class="opacity-50">f203</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laugh me-3 fa-2x"></i>
					<div>laugh <div class="opacity-50">f599</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-laugh me-3 fa-2x"></i>
					<div>laugh <div class="opacity-50">f599</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laugh-beam me-3 fa-2x"></i>
					<div>laugh-beam <div class="opacity-50">f59a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-laugh-beam me-3 fa-2x"></i>
					<div>laugh-beam <div class="opacity-50">f59a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laugh-squint me-3 fa-2x"></i>
					<div>laugh-squint <div class="opacity-50">f59b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-laugh-squint me-3 fa-2x"></i>
					<div>laugh-squint <div class="opacity-50">f59b</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-laugh-wink me-3 fa-2x"></i>
					<div>laugh-wink <div class="opacity-50">f59c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-laugh-wink me-3 fa-2x"></i>
					<div>laugh-wink <div class="opacity-50">f59c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-lightbulb me-3 fa-2x"></i>
					<div>lightbulb <div class="opacity-50">f0eb</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-line me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-microsoft me-3 fa-2x"></i>
					<div>microsoft <div class="opacity-50">f3ca</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-minus me-3 fa-2x"></i>
					<div>minus <div class="opacity-50">f068</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-minus-circle me-3 fa-2x"></i>
					<div>minus-circle <div class="opacity-50">f056</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-minus-square me-3 fa-2x"></i>
					<div>minus-square <div class="opacity-50">f146</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-minus-square me-3 fa-2x"></i>
					<div>minus-square <div class="opacity-50">f146</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-mix me-3 fa-2x"></i>
					<div>mix <div class="opacity-50">f3cb</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-mixcloud me-3 fa-2x"></i>
					<div>mixcloud <div class="opacity-50">f289</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-mizuni me-3 fa-2x"></i>
					<div>mizuni <div class="opacity-50">f3cc</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-mobile me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-modx me-3 fa-2x"></i>
					<div>modx <div class="opacity-50">f285</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-monero me-3 fa-2x"></i>
					<div>monero <div class="opacity-50">f3d0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-money-bill me-3 fa-2x"></i>
					<div>money-bill <div class="opacity-50">f0d6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-money-bill-alt me-3 fa-2x"></i>
					<div>money-bill-alt <div class="opacity-50">f3d1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-money-bill-alt me-3 fa-2x"></i>
					<div>money-bill-alt <div class="opacity-50">f3d1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-play-circle me-3 fa-2x"></i>
					<div>play-circle <div class="opacity-50">f144</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-playstation me-3 fa-2x"></i>
					<div>playstation <div class="opacity-50">f3df</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-plug me-3 fa-2x"></i>
					<div>plug <div class="opacity-50">f1e6</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-plus me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-question-circle me-3 fa-2x"></i>
					<div>question-circle <div class="opacity-50">f059</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-quidditch me-3 fa-2x"></i>
					<div>quidditch <div class="opacity-50">f458</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-quinscape me-3 fa-2x"></i>
					<div>quinscape <div class="opacity-50">f459</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-quora me-3 fa-2x"></i>
					<div>quora <div class="opacity-50">f2c4</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-quote-left me-3 fa-2x"></i>
					<div>quote-left <div class="opacity-50">f10d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-quote-right me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-rocketchat me-3 fa-2x"></i>
					<div>rocketchat <div class="opacity-50">f3e8</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-rockrms me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-save me-3 fa-2x"></i>
					<div>save <div class="opacity-50">f0c7</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-schlix me-3 fa-2x"></i>
					<div>schlix <div class="opacity-50">f3ea</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-school me-3 fa-2x"></i>
					<div>school <div class="opacity-50">f549</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-screwdriver me-3 fa-2x"></i>
					<div>screwdriver <div class="opacity-50">f54a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-scribd me-3 fa-2x"></i>
					<div>scribd <div class="opacity-50">f28a</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-scroll me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-servicestack me-3 fa-2x"></i>
					<div>servicestack <div class="opacity-50">f3ec</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-shapes me-3 fa-2x"></i>
					<div>shapes <div class="opacity-50">f61f</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-share me-3 fa-2x"></i>
					<div>share <div class="opacity-50">f064</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-share-alt me-3 fa-2x"></i>
					<div>share-alt <div class="opacity-50">f1e0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-share-alt-square me-3 fa-2x"></i>
					<div>share-alt-square <div class="opacity-50">f1e1</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-share-square me-3 fa-2x"></i>
					<div>share-square <div class="opacity-50">f14d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-share-square me-3 fa-2x"></i>
					<div>share-square <div class="opacity-50">f14d</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-shekel-sign me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-shirtsinbulk me-3 fa-2x"></i>
					<div>shirtsinbulk <div class="opacity-50">f214</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-shoe-prints me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-shopping-basket me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-tags me-3 fa-2x"></i>
					<div>tags <div class="opacity-50">f02c</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-tape me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-times me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-trello me-3 fa-2x"></i>
					<div>trello <div class="opacity-50">f181</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-tripadvisor me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-user me-3 fa-2x"></i>
					<div>user <div class="opacity-50">f007</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-alt me-3 fa-2x"></i>
					<div>user-alt <div class="opacity-50">f406</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-alt-slash me-3 fa-2x"></i>
					<div>user-alt-slash <div class="opacity-50">f4fa</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-astronaut me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="far fa-user-circle me-3 fa-2x"></i>
					<div>user-circle <div class="opacity-50">f2bd</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-graduate me-3 fa-2x"></i>
					<div>user-graduate <div class="opacity-50">f501</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-injured me-3 fa-2x"></i>
					<div>user-injured <div class="opacity-50">f728</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-lock me-3 fa-2x"></i>
					<div>user-lock <div class="opacity-50">f502</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-lg me-3 fa-2x"></i>
					<div>user-lg <div class="opacity-50">f0f0</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-minus me-3 fa-2x"></i>
					<div>user-minus <div class="opacity-50">f503</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-ninja me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-secret me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-slash me-3 fa-2x"></i>
					<div>user-slash <div class="opacity-50">f506</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-user-tag me-3 fa-2x"></i>
			...
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fab fa-ussunnah me-3 fa-2x"></i>
					<div>ussunnah <div class="opacity-50">f407</div></div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-4">
				<div class="d-flex align-items-center">
					<i class="fas fa-utensil-spoon me-3 fa-2x"></i>

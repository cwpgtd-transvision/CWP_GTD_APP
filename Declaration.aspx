<%@ Page Title="" Language="C#" MasterPageFile="~/GTDMaster.master" AutoEventWireup="true" CodeFile="Declaration.aspx.cs" Inherits="Declaration" %>
    ...
    <script>
        ...
        function BindData() {
            ...
            $.ajax({
                ...
                url: '/Declaration.aspx/BindData',
                data: JSON.stringify({ date: date, Genid: Genid, GenUnitid: GenUnitid, Revision: Revision, OnbarOffbarBool: OnbarOffbarBool }),
                async: true,
        ...
        function BindSeller() {
            ...
            $.ajax({
                ...
                url: '/Declaration.aspx/BindSeller',
        ...
        function BindSellerUnits() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json;charset=utf-8',
                url: '/Declaration.aspx/BindSellerUnits',
        ...
        function BindRevisions() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json;charset=utf-8',
                url: '/Declaration.aspx/BindRevisions',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card mt-2">
        <div class="card-header card-hearder-custom d-flex align-items-center py-0">
            <h6 class="mb-0 py-2">Declaration Report</h6>

...
const themeSwitcher = function () {
    ...
    const layoutTheme = function () {
        ...
        var backgroundImageTheme = 'backgroundimg';
        var customThemeMainOne = 'customThemeOne';
        var customThemeMainTwo = 'customThemeTwo';
        var customThemeMainThree = 'customThemeThree';
        ...
        function applyTheme(mode) {
            ...
            else if (mode == backgroundImageTheme) {
                st.setAttribute('data-color-theme', 'backgroundimg');
            }
            else if (mode == customThemeMainOne) {
                st.setAttribute('data-color-theme', 'customThemeOne');
            }
            else if (mode == customThemeMainTwo) {
                st.setAttribute('data-color-theme', 'customThemeTwo');
            }
            else if (mode == customThemeMainThree) {
                st.setAttribute('data-color-theme', 'customThemeThree');
            }
            else {
                if (!mql.matches) {
                    st.setAttribute('data-color-theme', 'dark');

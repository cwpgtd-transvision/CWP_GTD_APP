...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        ...
        $(function () {
            ...
            $('#ddlSeller').on('change', function () {
                $("#divTable").hide();
                var Seller = $('#ddlSeller').val();
                //alert(Seller);
                if (Seller === "0") {
                    $('.divSellerUnits').hide();   // use class selector
                } else {
                    $('.divSellerUnits').show();   // use class selector
                }
            ...
            $('#viewType').on('change', function () {
                var View_Type_condition = $('#viewType').is(':checked') ? "buyerview" : "sellerview";

                if (View_Type_condition === "buyerview") {
                    $('.divBuyer').show();   // use class selector
                } else {
                    $('.divBuyer').hide();   // use class selector
                }
            });
        });
        function BindData() {
            ...
            View_Type = $('#viewType').is(':checked') ? "buyerview" : "sellerview";
            //alert(View_Type);
            //alert(OnbarOffbarBool);
            //return;
            ...
            $.ajax({
                ...
                url: '/EntitalmentReport.aspx/BindData',
                data: JSON.stringify({ date: date, Buyerid: Buyerid, Genid: Genid, GenUnitid: GenUnitid, Revision: Revision, OnbarOffbarBool: OnbarOffbarBool, View_Type: View_Type }),
                async: true,
        ...
        function BindBuyer() {
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json;charset=uts-8',
                url: '/EntitalmentReport.aspx/BindBuyer',
                data: JSON.stringify({}),
                async: true,
                success: function (data, textStatus, jqXHR) {
                    $("#ddlBuyer").empty();
        ...
        function BindSeller() {
            ...
            $.ajax({
                ...
                url: '/EntitalmentReport.aspx/BindSeller',
        ...
        function BindSellerUnits() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json;charset=utf-8',
                url: '/EntitalmentReport.aspx/BindSellerUnits',
        ...
        function BindRevisions() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json;charset=utf-8',
                url: '/EntitalmentReport.aspx/BindRevisions',
        ...
        <div class="slider round">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-md-3 divSellerUnits">
                ...
                <div class="row">
                    <div class="col-md-12 text-end mt-0 mb-2">

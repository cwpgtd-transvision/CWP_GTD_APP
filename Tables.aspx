<%@ Page Title="" Language="C#" MasterPageFile="~/GTDMaster.master" AutoEventWireup="true" CodeFile="Tables.aspx.cs" Inherits="Tables" %>
					...
					<div class="page-header-content d-lg-flex">
						<div class="d-flex">
							<h4 class="page-title mb-0">
								Data - <span class="fw-normal">Tables</span>
							</h4>
...
<div class="page-header">
				<div class="page-header-content d-lg-flex">
					<div class="d-flex">
						<h4 class="page-title mb-0">
							Handson - <span class="fw-normal">Tables</span>
						</h4>
